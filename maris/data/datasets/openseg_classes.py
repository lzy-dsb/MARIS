...
def get_coco_categories_with_prompt_eng():
    ...
    coco_id_names = open('./maris/data/datasets/coco_panoptic_with_prompt_eng.txt').read().splitlines()
    coco_idx = 0
...
def get_waterovs_categories_with_prompt_eng_train():
    WATEROVS_CATEGORIES_ = copy.deepcopy(WATEROVS_CATEGORIES_TRAIN)
    # waterovs_id_names = open('./maris/data/datasets/waterovs_with_prompt_eng.txt').read().splitlines()
    # waterovs_idx = 0
    # for line in waterovs_id_names:
    #     idx, name = line.split(':')
    #     idx = int(idx)
    #     if idx == 0 or name == "invalid_class_id":
    #         continue
    #     #print(COCO_CATEGORIES_[coco_idx]["name"], '->', name)
    #     assert WATEROVS_CATEGORIES_[waterovs_idx]["id"] == idx
    #     WATEROVS_CATEGORIES_[waterovs_idx]["name"] = name
    #     waterovs_idx += 1
    return WATEROVS_CATEGORIES_

def get_waterovs_categories_with_prompt_eng_val():
    WATEROVS_CATEGORIES_ = copy.deepcopy(WATEROVS_CATEGORIES_VAL)
    # waterovs_id_names = open('./maris/data/datasets/waterovs_with_prompt_eng.txt').read().splitlines()
    # waterovs_idx = 0
    # for line in waterovs_id_names:
    #     idx, name = line.split(':')
...
def get_coco_stuff_categories_with_prompt_eng():
    ...
    coco_id_names = open('./maris/data/datasets/coco_stuff_with_prompt_eng.txt').read().splitlines()
    coco_idx = 0
    for line in coco_id_names:
        idx, name = line.split(':')
        idx = int(idx)
...
def get_ade20k_categories_with_prompt_eng():
    ...
    ade20k_id_names = open('./maris/data/datasets/ade20k_150_with_prompt_eng.txt').read().splitlines()
    ade_idx = 0
...
def get_cityscapes_categories_with_prompt_eng():
    ...
    cityscapes_id_names = open('./maris/data/datasets/cityscapes_with_prompt_eng.txt').read().splitlines()
    cityscapes_idx = 0
...
def get_ade20k_847_categories_with_prompt_eng():
    ...
    ade20k_847_id_names = open('./maris/data/datasets/ade20k_847_with_prompt_eng.txt').read().splitlines()
    ade_idx = 0
...
def get_pascal_21_categories_with_prompt_eng():
    ...
    pascal_21_id_names = open('./maris/data/datasets/pascal_voc_21_with_prompt_eng.txt').read().splitlines()
    pas_idx = 0
...
def get_pascal_ctx_459_categories_with_prompt_eng():
    ...
    pascal_ctx_459_id_names = open('./maris/data/datasets/pascal_ctx_459_with_prompt_eng.txt').read().splitlines()
    pas_idx = 0
...
def get_pascal_ctx_59_categories_with_prompt_eng():
    ...
    pascal_ctx_59_id_names = open('./maris/data/datasets/pascal_ctx_59_with_prompt_eng.txt').read().splitlines()
    pas_idx = 0
...
def get_mapillary_vistas_categories_with_prompt_eng():
    ...
    mapillary_vistas_id_names = open('./maris/data/datasets/mapillary_vistas_with_prompt_eng.txt').read().splitlines()
    mapillary_idx = 0
