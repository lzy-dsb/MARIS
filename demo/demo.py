...
def get_parser():
    parser = argparse.ArgumentParser(description="maris demo for builtin configs")
    parser.add_argument(
        "--config-file",
        default="configs/coco/panoptic-segmentation/maris/maris_convnext_large_eval_ade20k.yaml",
        metavar="FILE",
